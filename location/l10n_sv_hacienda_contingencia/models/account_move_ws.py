...
######################################################################################################### FCE-CONTINGENCIA
    ...
    #     _logger.info("SIT sit_base_map_invoice_info_identificacion self Contingencia= %s", self)
    #     invoice_info = {}
    #     # self = data_inicial
    ...
    #     lines = []
    #     _logger.info("SIT sit_base_map_invoice_info_cuerpo_documento self Contingencia= %s", self.invoice_line_ids)
    #
